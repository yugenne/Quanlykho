...
#include <algorithm> // Thư viện cho các thuật toán chuỗi (sort vv...)
...
public:
    ...
    void Hienthidanhsachlaptopnhapxuat() const {
        ...
        cout << "\033[32m                           |==================================|\033[0m" << endl;
        cout << left << setw(5) << "STT" << setw(40) << "Ten Laptop" << setw(20) << "So luong" << setw(20) << "Gia mua" << endl;
        cout << "-------------------------------------------------------------------------------" << endl;
        int stt = 1;
        for (int i = 0; i < laptopnhap.size(); i++) {
            cout << left << setw(5) << stt++ << setw(40) << laptopnhap[i].GetTen() << setw(20) << laptopnhap[i].GetSoLuong() << setw(20) << fixed << setprecision(0) << laptopnhap[i].GetGiaMua() << endl;
        }
        cout << "-------------------------------------------------------------------------------" << endl;
        cout << "\033[31m                           |==================================|\033[0m" << endl;
        cout << "\033[31m                           |DANH SACH LAPTOP DA XUAT KHOI KHO |\033[0m" << endl;
        cout << "\033[31m                           |==================================\033[0m" << endl;
        cout << left << setw(5) << "STT" << setw(40) << "Ten Laptop" << setw(20) << "So luong" << setw(20) << "Gia ban" << endl;
        cout << "-------------------------------------------------------------------------------" << endl;
        int stt1 = 1;
        for (int i = 0; i < laptopxuat.size(); i++) {
            cout << left << setw(5) << stt1++ << setw(40) << laptopxuat[i].GetTen() << setw(20) << laptopxuat[i].GetSoLuong() << setw(20) << fixed << setprecision(0) << laptopxuat[i].GetGiaBan() << endl;
        }
        cout << "-------------------------------------------------------------------------------" << endl;
    }
    double tinhdoanhthu() {
    ...
    void XuatLaptoprakhoikho(int& STT) {
        ...
        if (kho[STT - 1].GetSoLuong() >= soluongXuat) {
            ...
            cout << "Khong du so luong de xuat " << soluongXuat << " laptop " << kho[STT - 1].GetTen() << " ra kho." << endl;
        }
    }
    ...
    void XoaLaptop(int& STT) {
        ...
        if (kho[STT - 1].GetSoLuong() > 0) {
            cout << "\033[31mKhong the xoa laptop co so luong > 0.\033[0m" << endl;
            return;
        }
        cout << endl;
        cout << "---------------------------------------" << endl;
    ...
    void LocLaptopTheoCore(const string& core) {
        int Choice5;
    ...
    void xemthongtinchitietlaptop() {
        ...
        case 1:
            ...
            case 1:
                ...
                cout << "Nhap 1 phim bat ki de quay lai :";
                double i; cin >> i;
                system("cls");
                break;
            case 2:
...
int main() {
    ...
    do {
        ...
        case 6:
        {
            ...
            {
                system("cls");
                cout << "\033[32mChon  muon tim:\033[0m " << endl << endl;
                cout << "|-----------------------|" << endl;
                cout << "|1. Dell                |" << endl;
                cout << "|2. Asus                |" << endl;
                cout << "|3. HP                  |" << endl;
        ...
        case 7:
        {
            ...
            case 1:
                ...
                cout << "Nhap 1 so bat ki de quay tro lai:  ";
                cin >> j;
                system("cls");
                break;
            case 2:
